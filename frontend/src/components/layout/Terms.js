...
import Banner from '../user/Home/home-components/Banner'
const Terms = () => {

    return (
        
        <div className="wrapper">
            <Banner title="Terms and Conditions ('Terms')"/>
            <div className='text-start terms'>

            <h2>  </h2>
            <br />
        <p> Our Terms and Conditions were last updated on May 18, 2022.</p>
        <p>
        Please read these terms and conditions carefully before using Our Service.
        </p>
        <br />
        <h4>Interpretation and Definitions</h4><hr /><br />
    ...
    <li><b>“Company”</b> We refers to Technological University of the Philippines Taguig.</li>
    ...
    <li><b>“Website”</b> refers to Online Archiving Thesis System (O.A.T.S.), accessible from https://www.oats-tupt.me/.</li>
    <li><b>“You”</b> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
    </li>
    </ul>

    <br />
    <br/><br/><h4>Acknowledgement</h4><hr/>
    ...
    <br/><br/><h4>Content</h4><hr/>
    <br/><h5>Your Right to Post Content</h5>
    ...
    <li>Defamatory, discriminatory, or mean-spirited content, including references or commentary about religion, race, sexual orientation, gender, national/ethnic origin, or other targeted groups.
        </li>
    <li>Spam, machine – or randomly – generated, constituting unauthorized or unsolicited advertising, chain letters, any other form of unauthorized solicitation, or any form of lottery or gambling.
        </li>   
    ...
    <li>Infringing on any proprietary rights of any party, including patent, trademark, trade secret, copyright, right of publicity or other rights.
    </li>
    <li>Impersonating any person or entity including the Company and its employees or representatives.
    </li>
    <li>Violating the privacy of any third person.
    </li>
    <li>False information and features.
    </li>
    </ul>
    <p>
    ...
    <br />
    <br />
    If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email (oatstupt2122@gmail.com) and include in Your notice a detailed description of the alleged infringement.
    <br />
    <br />
    ...
    <p>By placing an Order for Products through the Service, You warrant that You are legally capable of entering into binding contracts.
    </p>
    <br/><h5>

    Your Information
    </h5>
    <p>If You wish to place an Order for Products available on the Service, You may be asked to supply certain information relevant to Your Order including, without limitation, Your name, Your Gcash sender name, Your Gcash sender number, and receipt.
    </p>
    <p>
    You represent and warrant that: (i) You have the legal right to use Gcash with any Order; and that (ii) the information You supply to us is true, correct and complete.
    </p>
    <p>
    ...
    <p>
    Payment can be made through Gcash using the Gcash QR code that is available on the website.

    Gcash account is subject to validation checks and authorization by GCash. If we do not receive the required authorization, We will not be liable for any delay or non-processing of Your Order.
    ...
    <p>he Service and its original content (excluding Content provided by You or other users), features and functionality are and will remain the exclusive property of 
    ...
    <br/><br/><h4>Links to Other Websites
    </h4><hr/>
...
<br />
    ...
    <br /><br /><h4>  "AS IS" and "AS AVAILABLE" Disclaimer </h4><hr />
...
<br />
    ...
    <h5>Philippines Legal Compliance</h5>

    <p>You represent and warrant that (i) You are not located in a country that is subject to the Philippine government embargo, or that has been designated by the Philippine government as a "terrorist supporting" country, and (ii) You are not listed on any Philippine government list of prohibited or restricted parties.
    </p>
    ...
    <ul>
        ...
        <li>
        By visiting this page on our website: https://www.oats-tupt.me/Contact
        </li>
        <li>
        By sending us an email: oatstupt2122@gmail.com
        </li>
    </ul>
            </div>
