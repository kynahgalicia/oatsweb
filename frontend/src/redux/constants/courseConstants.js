...
export const RESTORE_COURSE_REQUEST = 'RESTORE_COURSE_REQUEST'
export const RESTORE_COURSE_SUCCESS = 'RESTORE_COURSE_SUCCESS'
export const RESTORE_COURSE_RESET = 'RESTORE_COURSE_RESET'
export const RESTORE_COURSE_FAIL = 'RESTORE_COURSE_FAIL'
