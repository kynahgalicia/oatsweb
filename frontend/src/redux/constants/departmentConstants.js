...
export const ALL_DELETED_DEPARTMENT_REQUEST = 'ALL_DELETED_DEPARTMENT_REQUEST'
export const ALL_DELETED_DEPARTMENT_SUCCESS = 'ALL_DELETED_DEPARTMENT_SUCCESS'
export const ALL_DELETED_DEPARTMENT_FAIL = 'ALL_DELETED_DEPARTMENT_FAIL'
...
export const RESTORE_DEPARTMENT_REQUEST = 'RESTORE_DEPARTMENT_REQUEST'
export const RESTORE_DEPARTMENT_SUCCESS = 'RESTORE_DEPARTMENT_SUCCESS'
export const RESTORE_DEPARTMENT_RESET = 'RESTORE_DEPARTMENT_RESET'
export const RESTORE_DEPARTMENT_FAIL = 'RESTORE_DEPARTMENT_FAIL'
